...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Test', images: ['https://i.imgur.com/p3Xcnm8_d.jpg?maxwidth=520&shape=thumb&fidelity=high'], category: categories[1], price: 45, description: 'Inspired by the endearing signoff, the XO edition celebrates affection between friends, lovers, mothers and daughters, or, best of all, yourself. One of four pieces, the Pavé Diamond X Ring is handcrafted in 14k solid gold and set with responsibly sourced single cut pavé diamonds featuring a gentle overlap of the X'},
  ]);
